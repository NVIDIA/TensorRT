...
macro(configure_protobuf VERSION)
    ...
    find_file (AMZN_FOUND system-release PATHS /etc)
    if (CENTOS_FOUND OR ROCKY_FOUND OR AMZN_FOUND)
        set(Protobuf_LIB_DIR "${CMAKE_BINARY_DIR}/${Protobuf_TARGET}/lib64")
    else (CENTOS_FOUND OR ROCKY_FOUND OR AMZN_FOUND)
        set(Protobuf_LIB_DIR "${CMAKE_BINARY_DIR}/${Protobuf_TARGET}/lib")
    endif (CENTOS_FOUND OR ROCKY_FOUND OR AMZN_FOUND)
