...
PluginFieldCollection QKVToContextInterleavedPluginLegacyCreator::mFC{};
std::vector<PluginField> QKVToContextInterleavedPluginLegacyCreator::mPluginAttributes;
