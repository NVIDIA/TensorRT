...
IPluginV2DynamicExt* EmbLayerNormPluginDynamicLegacy::clone() const noexcept
{
    try
    {
        ...
        auto p = new EmbLayerNormPluginDynamicLegacy(
    ...
    char const* name, PluginFieldCollection const* fc) noexcept
{
    try
    {
        ...
        EmbLayerNormPluginDynamicLegacy* p
            = new EmbLayerNormPluginDynamicLegacy(name, output_fp16 ? DataType::kHALF : DataType::kFLOAT, mhaType, beta,
