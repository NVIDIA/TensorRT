...
def get_inference_time(perf_output):
    ...
    for line in perf_output.split('\n'):
        index = line.find('GPU Compute Time:')
        if index >= 0:
            stats = line[index + len('GPU Compute Time:'):].split(',')
            for stat in stats:
...
class TrtexecRunner(BaseRunner):
    ...
    trtexec_path=None, use_cuda_graph=None, avg_runs=None, best=None, duration=None, device=None, streams=None, min_timing=None, avg_timing=None, expose_dma=None, no_data_transfers=None, trtexec_warmup=None, trtexec_iterations=None,
    use_spin_wait=None, threads=None, use_managed_memory=None, dump_refit=None, dump_output=None, dump_profile=None, dump_layer_info=None, refit=None, separate_profile_run=None, trtexec_no_builder_cache=None, trtexec_profiling_verbosity=None, layer_precisions=None, layer_output_types=None, use_dla_core=None,
    input_shapes=None, profile_dicts=None, tf32=None, fp16=None, int8=None, allow_gpu_fallback=None, precision_constraints=None, workspace=None, use_dla=None, plugins=None, save_engine=None):
    ...
    def activate_impl(self):
        ...
        self.input_files = []
        self.export_output_file = tempfile.NamedTemporaryFile(delete=False)
        ...
        init_args_mapping = {
            **model_type_mapping,
            'exportOutput': self.export_output_file.name,
    ...
    def read_output_file(self):
        ...
        """
        outputs = OrderedDict()
        content = json.load(self.export_output_file)
    ...
    def infer_impl(self, feed_dict):
        ...
        perf_output = subprocess.run(self.cmd_args, stdout=subprocess.PIPE, text=True).\
                            stdout
        inference_time_stats = get_inference_time(perf_output)
        ...
        self.inference_time = inference_time_stats['median'] / 1000
        return outputs
