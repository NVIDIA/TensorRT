...
def main():
    ...
    parser.add_argument("--fail-node", help="The name(s) of the node(s) that 'fails'. "
                        "If multiple nodes are specified, they must all be present to cause a failure.", required=True, nargs="+")
    parser.add_argument("--default-return-code", help="The return code to use when there are no failures. ", default=0, type=int)
    parser.add_argument("--fail-return-code", help="The return code to use when there is a failure. ", default=1, type=int)
