...
[calibration API](https://docs.nvidia.com/deeplearning/tensorrt/10.x.x/_static/python-api/infer/Int8/Calibrator.html)
...
[developer guide](https://docs.nvidia.com/deeplearning/tensorrt/10.x.x/inference-library/work-quantized-types.html)
